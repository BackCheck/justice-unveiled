CREATE OR REPLACE FUNCTION get_platform_stats(p_case_id uuid DEFAULT NULL)
RETURNS jsonb
LANGUAGE sql
STABLE
AS $$
  SELECT jsonb_build_object(
    ...
    'inferred_connections', (SELECT COUNT(*) FROM entity_relationships WHERE is_verified = false AND (p_case_id IS NULL OR case_id = p_case_id)),
