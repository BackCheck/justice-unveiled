...
serve(async (req) => {
  ...
  try {
    ...
    const connections = Array.isArray(body.connections) ? body.connections.slice(0, 200) : [];
    const discrepancies = Array.isArray(body.discrepancies) ? body.discrepancies.slice(0, 50) : [];
