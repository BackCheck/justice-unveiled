...
serve(async (req) => {
  ...
  try {
    ...
    const relatedEvents = Array.isArray(body.relatedEvents) ? body.relatedEvents.slice(0, 50) : [];
    const connections = Array.isArray(body.connections) ? body.connections.slice(0, 100) : [];
