...
const DEFAULT_MARKERS = [
  ...
  { lat: 46.95, lng: 7.45, label: "Geneva" },
...
const DEFAULT_CONNECTIONS: { from: [number, number]; to: [number, number] }[] = [
  { from: [24.86, 67.01], to: [51.51, -0.13] },
  { from: [24.86, 67.01], to: [46.95, 7.45] },
  { from: [24.86, 67.01], to: [40.71, -74.01] },
  { from: [33.69, 73.04], to: [48.86, 2.35] },
  { from: [33.69, 73.04], to: [28.61, 77.21] },
  { from: [51.51, -0.13], to: [40.71, -74.01] },
  { from: [46.95, 7.45], to: [-1.29, 36.82] },
  { from: [40.71, -74.01], to: [6.52, 3.38] },
  { from: [-1.29, 36.82], to: [6.52, 3.38] },
];
