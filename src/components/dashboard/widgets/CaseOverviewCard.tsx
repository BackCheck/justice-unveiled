      ...
      <CardHeader className="relative pb-4">
        <div className="flex items-start justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <CardTitle className="text-lg font-semibold text-foreground">Danish Thanvi vs. Agencies</CardTitle>
              <p className="text-sm text-muted-foreground">Case File #001 • {t('dashboard.primaryInvestigation')}</p>
            </div>
          </div>
          <Badge className="bg-emerald-500/15 text-emerald-600 border-emerald-500/30 font-medium">ACQUITTED — May 2025</Badge>
        </div>
      </CardHeader>
      <CardContent className="relative space-y-5">
        ...
        <div className="flex flex-wrap items-center justify-between pt-4 border-t border-border/50">
          <div className="flex flex-wrap items-center gap-4">
            <div className="flex items-center gap-2 text-xs text-foreground/70"><Calendar className="w-3.5 h-3.5" /><span>2015 – 2025</span></div>
